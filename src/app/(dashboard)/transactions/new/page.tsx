  ...
  return (
    <div className="max-w-2xl">
      ...
      >
        ...
        {/* Recurring option */}
        <div className="mt-4 bg-secondary/50 rounded-lg border border-border p-4">
  ...
  return (
    <div className="mt-4 grid grid-cols-1 md:grid-cols-3 gap-4">
      <div>
        ...
        <select {...register("frequency")} className="w-full px-4 py-2 border border-input bg-card text-foreground rounded-lg">
      ...
      <div>
        ...
        <input type="date" {...register("nextDueDate")} className="w-full px-4 py-2 border border-input bg-card text-foreground rounded-lg" />
        {errors.nextDueDate && <p className="text-xs text-destructive mt-1">{errors.nextDueDate.message}</p>}
      </div>

      <div>
        <label className="block text-sm font-semibold text-foreground mb-2">(Optional) End Date</label>
        <input type="date" {...register("recurringEndDate")} className="w-full px-4 py-2 border border-input bg-card text-foreground rounded-lg" />
      </div>
    </div>
  );
}
